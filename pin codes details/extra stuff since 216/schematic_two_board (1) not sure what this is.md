...
- NEVER tie Board A's 3V3/5V to Board B's 3V3/5V. Each boa rd regulates its own.
...
TB6612 #2 PWMA   -> GPIO13          (front right)
TB6612 #2 AIN1   -> GPIO14
TB6612 #2 AIN2   -> GPIO16
TB6612 #2 AO1    -> Front right motor wire 1
TB6612 #2 AO2    -> Front right motor wire 2
TB6612 #2 PWMB   -> GPIO17          (front left)
TB6612 #2 BIN1   -> GPIO18
TB6612 #2 BIN2   -> GPIO19
...
TB6612 #3 PWMA   -> GPIO23          (back right)
TB6612 #3 AIN1   -> GPIO25
TB6612 #3 AIN2   -> GPIO26
TB6612 #3 AO1    -> Back right motor wire 1
TB6612 #3 AO2    -> Back right motor wire 2
TB6612 #3 PWMB   -> GPIO27          (back left)
TB6612 #3 BIN1   -> GPIO32
TB6612 #3 BIN2   -> GPIO33
